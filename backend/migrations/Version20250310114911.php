...
final class Version20250310114911 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tarification (id INT AUTO_INCREMENT NOT NULL, vehicule_id INT NOT NULL, prix_jour DOUBLE PRECISION DEFAULT NULL, prix_mois DOUBLE PRECISION DEFAULT NULL, prix_semaine DOUBLE PRECISION DEFAULT NULL, INDEX IDX_61328164A4A3511 (vehicule_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE tarification ADD CONSTRAINT FK_61328164A4A3511 FOREIGN KEY (vehicule_id) REFERENCES vehicule (id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE tarification DROP FOREIGN KEY FK_61328164A4A3511');
